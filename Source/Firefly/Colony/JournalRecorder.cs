...
namespace Firefly
{
    ...
    public class JournalRecorder
    {
        ...
        private static readonly string ThreadSummarizeSystemPrompt =
            ...
            "It must read as a consistent, short story including all the notable facts, the " +
            "beginning, and all impactful/consequential details in-between. The summary should also " +
            "read as curious about things. Occasionally pose questions about events that have vague " +
            "circumstances, potential consequences, or could lead to greater threads throughout the " +
            "world. You are invested in the future of this story, along with how it's played out so " +
            "far. \n\n" +
            "Preserve the thread's beginning, major turning points, current state, and unresolved " +
            "stakes. Preserve guesses, possibilities, and open questions as uncertainty, woven as " +
            "underlying texture within the paragraph. Keep the result concise and no longer than " +
            "10 lines.\n\n" +
            ...
            "equivalent instead.\n\n" +
            "Example summary:\n" +
            "\"The colony seems to have gotten involved with something shady. It started when an " +
            "ominous stranger showed up one day and dropped off a mysterious gift - which attracted " +
            "the attention of The Royal Empire a few days later. They bought the gift off the colony " +
            "for a moderate sum after inquiring about the mysterious stranger, and the colony hasn't " +
            "heard any news since. Who was this ominous stranger, and why is the Empire looking for " +
            "them? What secrets does this item hold? Maybe the colony should try to forget about this " +
            "encounter and just move on...\"\n\n" +
